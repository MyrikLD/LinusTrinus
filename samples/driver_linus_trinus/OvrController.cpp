...
public:
    ...
    std::string m_controllerTrackingSystemName = "oculus";
    std::string m_controllerManufacturerName = "Oculus";
    std::string m_controllerModelNumber = "Oculus Rift S";
    std::string m_controllerRenderModelNameLeft = "oculus_rifts_controller_left";
    std::string m_controllerRenderModelNameRight = "oculus_rifts_controller_right";
    std::string m_controllerSerialNumber = "1WMGH000XX0000_Controller";
    std::string m_controllerType = "oculus_touch";
    std::string mControllerRegisteredDeviceType = "oculus/1WMGH000XX0000_Controller";
    std::string m_controllerInputProfilePath = "{oculus}/input/touch_profile.json";
...
{
	DriverLog("RemoteController::Activate. objectId=%d\n", unObjectId);
...
{
	DriverLog("RemoteController::Deactivate\n");
	m_unObjectId = vr::k_unTrackedDeviceIndexInvalid;
}
...
{
	DriverLog("RemoteController::GetComponent. Name=%hs\n", pchComponentNameAndVersion);
